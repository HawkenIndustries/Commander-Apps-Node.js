/* 
  THIS FILE MODIFIES MATERIALIZE function $.fn.carousel
  BY COMPLETELY REPLACING IT.
  When updating materialize it is required that this file is updated.
  Modified sections are noted by the following:

  MODIFIED
  END MODIFIED

  Ensure that when you update materialize that the following still work in desktop (click) and mobile (touch):
    - Carousel scrolling 
    ...
    init : function(options) {
      ...
      return this.each(function(i) {
        ...
        function scroll(x) {
          ...
          for (i = 1; i <= half; ++i) {
            ...
            if (options.fullWidth) {
              ...
              tweenedOpacity = 1 - 0.2 * (i * 1 + tween * dir);
            }
            // Don't show wrapped items.
        ...
        function click(e) {
          ...
          if($(e.target).parents('.carousel').hasClass('disabled')){
            return false;
          }
          /* END MODIFIED */
