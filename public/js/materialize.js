/*!
 * Materialize v0.99.0_MODIFIED (http://materializecss.com)
      ...
      function placeDropdown(eventType) {
        ...
        setTimeout(function() {
          $(document).on('click.'+ activates.attr('id'), function (e) {
            ...
            // CWG: Don't try to hide if select-dropdown. Chrome 73+ bug
            if(!activates.hasClass('select-dropdown')){
              hideDropdown(); 
            }
...
;(function($) {
  ...
  var methods = {
    init : function(options) {
      ...
      // Override defaults
      options = $.extend(defaults, options);
      console.log('MODAL OPTIONS',this, options)
...
;(function ($) {
  ...
  $.fn.material_select = function (callback) {
    $(this).each(function(){
      var $select = $(this);
      console.log('material_select',$select);
